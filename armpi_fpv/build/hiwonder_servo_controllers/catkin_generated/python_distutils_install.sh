...
echo_and_run cd "/home/armpi/桌面/ros/armpi_fpv/src/hiwonder_servo_controllers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/armpi/桌面/ros/armpi_fpv/src/hiwonder_servo_controllers/setup.py" \
     \
    build --build-base "/home/armpi/桌面/ros/armpi_fpv/build/hiwonder_servo_controllers" \
    install \
    --root="${DESTDIR-/}" \
